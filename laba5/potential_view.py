...
class Ui_form_potential(object):
    ...
    def retranslateUi(self, form_potential):
        ...
        self.le_class_0_point_0_y.setText(_translate("form_potential", "0"))
        self.le_class_0_point_0_y.setPlaceholderText(_translate("form_potential", "0"))
        self.le_class_0_point_0_x.setText(_translate("form_potential", "-1"))
        self.le_class_0_point_0_x.setPlaceholderText(_translate("form_potential", "-1"))
        ...
        self.le_class_0_point_1_y.setText(_translate("form_potential", "1"))
        self.le_class_0_point_1_y.setPlaceholderText(_translate("form_potential", "1"))
        self.le_class_0_point_1_x.setText(_translate("form_potential", "1"))
        self.le_class_0_point_1_x.setPlaceholderText(_translate("form_potential", "1"))
        ...
        self.le_class_1_point_0_y.setText(_translate("form_potential", "0"))
        self.le_class_1_point_0_y.setPlaceholderText(_translate("form_potential", "0"))
        self.le_class_1_point_0_x.setText(_translate("form_potential", "2"))
        self.le_class_1_point_0_x.setPlaceholderText(_translate("form_potential", "2"))
        ...
        self.le_class_1_point_1_y.setText(_translate("form_potential", "-2"))
        self.le_class_1_point_1_y.setPlaceholderText(_translate("form_potential", "-2"))
        ...
        self.le_point_y.setText(_translate("form_potential", "0"))
        self.le_point_y.setPlaceholderText(_translate("form_potential", "0"))
        self.le_point_x.setText(_translate("form_potential", "2"))
        self.le_point_x.setPlaceholderText(_translate("form_potential", "2"))
